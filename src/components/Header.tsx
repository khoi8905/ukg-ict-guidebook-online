      ...
      <div className="bg-gradient-to-r from-blue-50 to-emerald-50 rounded-2xl p-6 border border-blue-200 shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-xl p-6 shadow-md border border-blue-100">
            <h3 className="font-bold text-slate-800 text-lg mb-2">1. Ujian Pedagogik</h3>
            <p className="text-slate-600 mb-3">Materi Ajar + Video</p>
            <p className="text-blue-700 text-sm font-medium">
              Pengumpulan: 16-21 Juni 2025<br />
              Maks. 21 Juni 2025 pukul 14.00 WIB
            </p>
          </div>
