      ...
      <div className="bg-gradient-to-r from-blue-50 to-emerald-50 rounded-2xl p-8 border border-blue-200">
        <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-12 mb-8">
          <div className="text-center">
            ...
            <p className="text-slate-700 font-semibold">Pengumpulan Materi & Video Presentasi</p>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">Teknikal Kognitif</p>
          </div>
        </div>

        <div className="flex w-full rounded-xl overflow-hidden shadow-lg">
          <div className="bg-blue-500 text-white text-center py-4 font-bold text-lg flex items-center justify-center" style={{ width: '50%' }}>
            Video (30%)
          </div>
          <div className="bg-emerald-500 text-white text-center py-4 font-bold text-lg flex items-center justify-center" style={{ width: '50%' }}>
            Proyek (70%)
          </div>
        </div>
      </div>
